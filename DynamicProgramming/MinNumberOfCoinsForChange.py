# Given an array of positive integers representing coin denominations and a single non-
# negative integer n representing a target amount of money, write a function that
